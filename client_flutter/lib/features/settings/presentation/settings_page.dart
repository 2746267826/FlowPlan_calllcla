...
final androidUsageAccessStatusProvider =
    FutureProvider.autoDispose<bool>((ref) {
  return AndroidUsageStatsService().hasUsageAccessPermission();
});
...
class SettingsPage extends ConsumerWidget {
  const SettingsPage({super.key, bool? isAndroidOverride})
            ...
            children: [
              ...
              if (isWindowsDesktop)
                SwitchListTile(
                  ...
                  onChanged: (value) {
                    ref
                        .read(minimizeToTrayNotifierProvider.notifier)
                        .set(value);
                  },
                ),
              if (isWindowsDesktop)
                SwitchListTile(
                  ...
                  onChanged: (value) {
                    ref
                        .read(launchAtStartupNotifierProvider.notifier)
                        .set(value);
                  },
                ),
              ListTile(
              ...
              ListTile(
                ...
                trailing: DropdownButton<int>(
                  ...
                  onChanged: (value) {
                    ...
                    ref
                        .read(firstDayOfWeekNotifierProvider.notifier)
                        .set(value);
                  },
                ),
              ),
