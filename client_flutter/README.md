...
| **产品文档** | 已迁移到 `../docs/`，历史资料在 `../docs/archive/legacy-root-plans/` |
...
- 发布前请参考当前目录 `RELEASE_CHECKLIST.md` 执行完整回归验证；Codex 不主动运行 `dart` / `flutter` 命令，需要由开发者本机执行并反馈结果。

---

## ✅ 发布验证

当前发布准备基线为 **v1.4.4+144**，对应 `../docs/archive/legacy-root-plans/plan260424.md` 的 P1“信息架构与页面层级整理”收口阶段。
...
详细命令、人工验收步骤和阻断项见当前目录 `RELEASE_CHECKLIST.md`。
