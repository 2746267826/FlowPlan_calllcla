...
Write-Host '[flowplan-web-admin] log: C:\Users\a2746\Desktop\calll260426\logs\20260429_131357\flowplan-web-admin.log'
Write-Host '[flowplan-web-admin] command: npm run dev'
npm run dev 2>&1 | Tee-Object -FilePath 'C:\Users\a2746\Desktop\calll260426\logs\20260429_131357\flowplan-web-admin.log'
Write-Host ''
